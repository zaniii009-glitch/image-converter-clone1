                  ...
                  <div className="p-3 border-b border-gray-700">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-4 py-2 rounded border focus:outline-none placeholder-gray-500 ${
                          darkMode
                  ...
                  <div className="flex max-h-96">
                    ...
                    <div className="flex-1 p-4 overflow-y-auto bg-gray-900">
                      ...
                      {filteredFormats.length === 0 && (
                        <p className={`text-center py-8 ${darkMode ? 'text-gray-500' : 'text-gray-400'}`}>No formats found</p>
                      )}
                    </div>
                  </div>
                </div>
                          ...
                          <div className="p-3 border-b border-gray-700">
                            <div className="relative">
                              ...
                              <input
                                ...
                                value={searchQuery}
                                onChange={(e) => setSearchQuery(e.target.value)}
                                className={`w-full pl-10 pr-4 py-2 rounded border focus:outline-none placeholder-gray-500 text-sm ${
                                  darkMode
                                    ? 'bg-gray-800 text-white border-gray-700 focus:border-indigo-500'
                                    : 'bg-white text-gray-900 border-gray-300 focus:border-indigo-500'
                                }`}
          ...
          {selectedFiles.length > 0 && convertedFiles.length === 0 && (
            <div className="flex flex-wrap items-center justify-between mb-8">
              <div className="relative file-dropdown">
                ...
                {showFileDropdown && (
                  <div className={`absolute left-0 mt-2 w-56 rounded shadow-lg z-50 text-left ${
